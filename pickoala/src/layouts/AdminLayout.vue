...
const navItems = computed(() => [
  ...
  {
    path: '/admin/system',
    label: t('admin.systemStatus.title') || 'System Status',
  ...
  {
    path: '/admin/files',
    label: t('admin.filesManagement') || 'Files',
  ...
  {
    path: '/admin/videos',
    label: t('admin.videosManagement') || 'Videos',
    icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>'
  },
  {
    path: '/admin/gallery',
...
const pageTitles = computed(() => ({
  '/admin': '',
  '/admin/system': t('admin.systemStatus.title') || 'System Status',
  '/admin/users': t('admin.usersManagement'),
  '/admin/images': t('admin.imagesManagement'),
  '/admin/files': t('admin.filesManagement') || 'Files',
  '/admin/videos': t('admin.videosManagement') || 'Videos',
