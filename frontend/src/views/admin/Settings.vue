      ...
      <div class="settings-content">
          ...
          <div class="settings-card" v-if="settings.upload" style="margin-bottom: 24px">
            ...
            <div class="form-row form-row--inline">
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perMinute') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.guest_video_limit_per_minute" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perHour') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.guest_video_limit_per_hour" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perDay') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.guest_video_limit_per_day" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row form-row--inline">
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perMinute') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.user_video_limit_per_minute" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perHour') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.user_video_limit_per_hour" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perDay') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.user_video_limit_per_day" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
            </div>
            ...
            <div class="form-row form-row--inline">
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perMinute') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.vip_video_limit_per_minute" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perHour') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.vip_video_limit_per_hour" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
              <div class="form-col">
                <label class="form-label">{{ $t('admin.perDay') }}</label>
                <div class="input-group">
                  <input v-model.number="settings.upload.vip_video_limit_per_day" type="number" class="form-input" />
                  <span class="input-group__suffix">{{ $t('admin.times') }}</span>
                </div>
              </div>
            </div>
        ...
        <div v-show="activeTab === 'home'" class="settings-section">
          ...
          <div class="settings-card">
            ...
            <div class="form-row">
              <textarea v-model="settings.home_features" class="form-input form-textarea" rows="6" placeholder='[{"zh": "Feature", "en": "Feature"}]'></textarea>
            </div>

            <div class="form-divider"></div>
            <h4 class="config-title">{{ $t('admin.homeTableCols') }} (Object)</h4>
             <div class="form-row">
              <textarea v-model="settings.home_table_cols" class="form-input form-textarea" rows="4" placeholder='{"col_guest": {"zh": "...", "en": "..."}}'></textarea>
            </div>

            <div class="form-divider"></div>
            <h4 class="config-title">{{ $t('admin.homeTableRows') }} (Object)</h4>
            <div class="form-row">
              <textarea v-model="settings.home_table_rows" class="form-input form-textarea" rows="6" placeholder='{"row_single_file": {"zh": "...", "en": "..."}}'></textarea>
            </div>
          </div>
        </div>
...
// ... (settings reactive object)
  upload: { 
    ...
    // Image Rate Limits
    guest_rate_limit_per_minute: 3, guest_rate_limit_per_hour: 10, guest_rate_limit_per_day: 30,
    user_rate_limit_per_minute: 10, user_rate_limit_per_hour: 100, user_rate_limit_per_day: 500,
    vip_rate_limit_per_minute: 30, vip_rate_limit_per_hour: 300, vip_rate_limit_per_day: 2000,
...
const guestVideoSizeMB = computed({
  get: () => Math.round(settings.upload.max_video_upload_size_guest / 1048576),
  set: (v) => { settings.upload.max_video_upload_size_guest = v * 1048576 }
})

const userVideoSizeMB = computed({
  get: () => Math.round(settings.upload.max_video_upload_size_user / 1048576),
  set: (v) => { settings.upload.max_video_upload_size_user = v * 1048576 }
})

const vipVideoSizeMB = computed({
  get: () => Math.round(settings.upload.max_video_upload_size_vip / 1048576),
  set: (v) => { settings.upload.max_video_upload_size_vip = v * 1048576 }
})
